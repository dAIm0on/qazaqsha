...
(function(){
  ...
  numberLesson('tens-1','Десятки 10–50',[10,11,12,13,14],'Он, жиырма, отыз, қырық, елу — отдельные слова, не «двадцать = два + десять». Запомни их как целые лексемы, вразброс, не считая по порядку.');
  numberLesson('tens-2','Десятки 60–90: не путать с 6–9',[15,16,17,18],'Алты и алпыс, жеті и жетпіс, сегіз и сексен, тоғыз и тоқсан начинаются похоже. Смотри на окончание. Дальше будет отдельный урок, где 6 и 60 чередуются.','Не учи «сначала все 60, потом все 6»: так мозг не учится отличать. Образы из 0–10 здесь уже не нужны.');
  numberLesson('hundreds','Слова жүз и мың',[19,20],'Сначала сами слова: жүз = 100, мың = 1000. Составные сотни и тысячи — следующими уроками, сначала с повторяющимися 5/50 и 8/80.');
  const newNumbers=[88,55,66,77,99,47,23,76,126,550,880,808,243,1550,8080,1888];
  ...
  lessons.push({id:'number-build',topic:'numbers',title:'Собираем любое число до 9999',method:'Крупные части → маленькие',tool:'number',
    intro:'Не учи каждое число как новое слово. Собери разряды. Сначала числа вроде 88 и 550 — в них единица и десяток одной семьи (8 и 80, 5 и 50).',
    steps:['88 = 80 + 8 → сексен сегіз.','550 = 500 + 50 → бес жүз елу. Снова 5 и 50.','1888 = 1000 + 800 + 80 + 8 → бір мың сегіз жүз сексен сегіз.'],
    items:[{front:'88',back:'сексен сегіз',cue:'80 + 8'},{front:'550',back:'бес жүз елу',cue:'5 и 50'},{front:'880',back:'сегіз жүз сексен',cue:'8 и 80'},{front:'1550',back:'бір мың бес жүз елу',cue:'5 и 50 внутри тысячи'}],

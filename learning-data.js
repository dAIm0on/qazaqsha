...
(function(){
  ...
  numberLesson('hundreds','Сотни и тысячи',[19,20],'Сначала называем, сколько сотен или тысяч: екі жүз = 200, үш мың = 3000. Для 100 достаточно жүз. Для 1000 — мың; в составных с одной тысячей пишем бір мың: 1504 = бір мың бес жүз төрт.');
  ...
  lessons.push({id:'number-build',topic:'numbers',title:'Собираем любое число до 9999',method:'Крупные части → маленькие',tool:'number',
    ...
    items:[{front:'17',back:'он жеті',cue:'10 + 7'},{front:'38',back:'отыз сегіз',cue:'30 + 8'},{front:'126',back:'жүз жиырма алты',cue:'100 + 20 + 6'},{front:'1001',back:'бір мың бір',cue:'1000 + 1'}],

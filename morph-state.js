...
function resumeSurface(view,hasMorphSession,lessonOpen){if(view==='morph'&&hasMorphSession)return 'morph';if(lessonOpen&&['practice','homework','learn','path','review'].includes(view))return view;return 'today';}

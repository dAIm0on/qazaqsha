(function(root){
 ...
 const config={
   ...
   session:{size:6,maxAttempts:10,recentWindowMs:600000,microSize:4,minIntervening:3,preferredIntervening:4,newLimit:5,examSize:8,examMs:4000,examHardMs:3000,examEasyMs:1500},
   context:{wordLimit:1},

 ...
 for(const l of data.lessons){
   ...
   if(l.id.startsWith('plural-')){
     ...
     for(const [title,explanation,ids] of [
       ['Двузначные: 88, 55, 66','В одном числе десяток и единица одной семьи: 88 = сексен сегіз (8 и 80).',[88,55,66,77,99]],
       ['Другие двузначные','47 = 40 + 7 → қырық жеті. Сначала десятки, потом единицы.',[47,23,76]],
       ['Трёхзначные: 550, 880','Снова 5 и 50, 8 и 80: бес жүз елу, сегіз жүз сексен.',[550,880,808,126]],
       ['Тысячи: 1550, 8080','бір мың бес жүз елу — снова 5 и 50. сегіз мың сексен — 8 и 80.',[1550,8080,1888]]

(function(){
'use strict';
const E=window.MorphEngine,S=window.MorphState,T=window.MorphTeachingData;
...
function teachingScreen(){
 ...
 message='Этот этап обучения ещё не подключён к интерфейсу Stage 4.';return teachingComplete(module,{...resume,stepIndex:1});
}
